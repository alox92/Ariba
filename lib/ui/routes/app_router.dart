...
import 'package:flashcards_app/ui/advanced_performance_screen.dart';
import 'package:flashcards_app/ui/review_screen.dart';
import 'package:flashcards_app/ui/stats_screen.dart';
import 'package:flashcards_app/ui/statistics_screen.dart';
...
import 'package:flashcards_app/ui/matching_game_screen.dart';
import 'package:flashcards_app/ui/writing_practice_screen.dart';
import 'package:flashcards_app/ui/study_mode_settings_screen.dart';
import 'package:flashcards_app/ui/study_session_analytics_screen.dart';
            ...
            routes: <RouteBase>[
              GoRoute(
                ...
                builder: (context, state) {
                  final deck = state.extra as domain.Deck?;
                  if (deck == null) {
                ...
                routes: [
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      final deck = map?['deck'] as domain.Deck?;
                      final card = map?['card'] as domain.Card?;
                      if (deck == null || card == null) {
                        return _navError(state.uri);
                      }
                      return MainLayout(
                          child: EditCardScreen(deck: deck, card: card));
                    },
                  ),                  GoRoute(
                    name: 'review',
                    path: 'review',
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      return StudySessionAnalyticsScreen(
                          deckId: deck.id, deckName: deck.name);
                    },
                  ),
                ],
