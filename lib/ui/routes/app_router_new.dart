...
import 'package:flashcards_app/ui/study_modes_screen.dart' as study_modes;
import 'package:flashcards_app/ui/quiz_mode_screen.dart' as quiz_mode;
import 'package:flashcards_app/ui/speed_round_screen.dart' as speed_round;
                ...
                routes: [
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      return study_modes.StudyModesScreen(deck: deck);
                    },
                  ),
                  GoRoute(
                    name: 'quizMode',
                    ...
                    builder: (context, state) {
                      ...
                      return quiz_mode.QuizModeScreen(
                          deckId: deck.id, deckName: deck.name);
                    },
                  ),
                  GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      return speed_round.SpeedRoundScreen(
                          deckId: deck.id, deckName: deck.name);
                    },
                  ),
                ],
